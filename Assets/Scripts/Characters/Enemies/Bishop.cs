...
public class Bishop : EnemyChess
{
    private readonly Vector2Int[] MoveRule = new Vector2Int[] { new Vector2Int(1, 1), new Vector2Int(-1, 1), new Vector2Int(1, -1), new Vector2Int(-1, -1) };
    ...
    protected override bool CanChessMate()
    {
        ...
        if (Mathf.Abs(direction.x) != Mathf.Abs(direction.y)) return false;
